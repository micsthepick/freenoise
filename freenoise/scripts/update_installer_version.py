...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=freenoise Demo Installer\n"
      else:
        line="OutputBaseFilename=freenoise Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the freenoise Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the freenoise installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=freenoise Demo installer\n"
     else:
       line="SetupWindowTitle=freenoise installer\n"
